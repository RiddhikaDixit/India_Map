...
def files():
    positions()
    draw(positions.upper_india, co = (0, 191, 255), mode = 0)
    draw(positions.lower_india, co = (0, 191, 255), mode = 0)
    draw(positions.upper_saff, co = (255, 167, 31), mode = 0)
    draw(positions.lower_saff, co = (255, 167, 31), mode = 0)
    draw(positions.green_area, co = (34, 139, 34), mode = 0)
    ...
    turtle.color('red')
    style = ('Arial', 35, 'normal')
    turtle.write('HAPPY INDEPENDENCE DAY', font=style, align='center')
